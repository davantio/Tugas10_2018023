...
public class MyAdapter  extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MyAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.txtlocation.setText(model.getUserlocation());
                    ...
                    public boolean onMenuItemClick(MenuItem item)
                    {
                        switch (item.getItemId()){
                            case R.id.edit_menu:
                                ...
                                bundle.putString("location",model.getUserlocation());
                                bundle.putString("price",model.getUserprice());
                                bundle.putByteArray("avatar",model.getProavatar());
                                Intent intent = new Intent(context, InputHotel.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtname,txtstar,txtlocation, txtprice;
